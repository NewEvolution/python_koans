...
class AboutIteration(Koan):
    ...
    def test_iterating_with_next(self):
        ...
        self.assertRegex(err_msg, r'Ran out')
    ...
    def test_reduce_will_blow_your_mind(self):
        ...
        # - it iteratively applies the provided function across
        #   the provided iterable of values, using the result
        #   as the following input, starting with the 3rd argument
        #   if one is provided
